...
import com.yeyanxiang.view.smoothprogressbar.SmoothProgressBar;
 ...
 * @简介
 */
public class MakeCustomProgressbarActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.customsmoothprogressbarlayout);
		...
		mSeekBarSectionsCount
				.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
					@Override
					public void onProgressChanged(SeekBar seekBar,
							int progress, boolean fromUser) {
						mSectionsCount = progress + 1;
						mTextViewSectionsCount.setText("Sections count: "
								+ mSectionsCount);
					}
		...
		mSeekBarSeparatorLength
				.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
					@Override
					public void onProgressChanged(SeekBar seekBar,
							int progress, boolean fromUser) {
						mSeparatorLength = progress;
						mTextViewSeparatorLength.setText(String.format(
								"Separator length: %ddp", mSeparatorLength));
					}
		...
		mSeekBarStrokeWidth
				.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
					...
					public void onProgressChanged(SeekBar seekBar,
						...
						mTextViewStrokeWidth.setText(String.format(
								"Stroke width: %ddp", mStrokeWidth));
					}
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_item, getResources()
						.getStringArray(R.array.interpolators));
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		mSpinnerInterpolators.setAdapter(adapter);
	...
	private void setValues() {
		...
		mProgressBar
				.setSmoothProgressDrawableSeparatorLength(dpToPx(mSeparatorLength));
		mProgressBar.setSmoothProgressDrawableStrokeWidth(dpToPx(mStrokeWidth));
		mProgressBar.setSmoothProgressDrawableReversed(mCheckBoxReversed
				.isChecked());
		mProgressBar.setSmoothProgressDrawableMirrorMode(mCheckBoxMirror
				.isChecked());
		...
		mProgressBar.setSmoothProgressDrawableColors(getResources()

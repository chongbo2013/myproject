...
public final class PullToRefreshListActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mPullRefreshListView.getRefreshableView().setOnScrollListener(
				new AbsListView.OnScrollListener() {
					...
					public void onScrollStateChanged(AbsListView view,
						...
						if (SCROLL_STATE_IDLE == scrollState
							...
							if (!mallLayoutHasHide && !isAnimationPlaying
									&& diff >= ANIMATIONS_MIN_DELAY) {
	...
	private PullToRefreshBase.HeaderPullingListener listener = new PullToRefreshBase.HeaderPullingListener() {
		...
		public void onHeaderPulling(int orientation, int scrollDistance) {
			...
			if (Math.abs(scrollDistance) < MIN_TIGGER_DISTANCE)
				return;
			long currentTime = System.currentTimeMillis();
			long diff = currentTime - lastDelayTime;
			if (mallLayoutHasHide && !isAnimationPlaying
	...
	private void setupAnimation() {
		...
		hideAnimation
				.setOnTransformListener(new TranslateAnimation.OnTransformListener() {
					@Override
	...
	private String[] mStrings = { "Abbaye de Belloc",
			...
			"Airag", "Airedale", "Aisy Cendre", "Allgauer Emmentaler",
			"Abbaye de Belloc", "Abbaye du Mont des Cats", "Abertam",
			"Abondance", "Ackawi", "Abbaye de Belloc",
			"Abbaye du Mont des Cats", "Abertam", "Abondance", "Ackawi",
			"Acorn", "Adelost", "Affidelice au Chablis", "Afuega'l Pitu",
			"Airag", "Airedale", "Aisy Cendre", "Allgauer Emmentaler",
			"Abbaye de Belloc", "Abbaye du Mont des Cats", "Abertam",
			"Abondance", "Ackawi", "Allgauer Emmentaler" };
}

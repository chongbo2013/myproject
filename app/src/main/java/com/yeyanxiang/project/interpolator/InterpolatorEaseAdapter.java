package com.yeyanxiang.project.interpolator;
...
public class InterpolatorEaseAdapter extends BaseAdapter {
    ...
    public InterpolatorEaseAdapter(Context context, List<String> nameList, List<Interpolator> interpolatorList, long duration) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.interpolator_adapter, null);

...
public class FeedsFragment extends BaseFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View contentView = inflater.inflate(R.layout.fragment_feed, container,
                false);
        ButterKnife.inject(this, contentView);

        parseArgument();
        mDataHelper = new FeedsDataHelper(getActivity(), mCategory);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String imageUrl = mAdapter.getItem(position
                        - gridView.getHeaderViewsCount()).images.large;
    ...
    private void initActionBar() {
        View actionBarContainer = ActionBarUtils
                .findActionBarContainer(getActivity());
    ...
    private void loadData(String next) {
        ...
        executeRequest(new GsonRequest(String.format(GagApi.LIST,
                mCategory.name(), next), FeedRequestData.class,
                responseListener(), errorListener()));
    }

    private Response.Listener<FeedRequestData> responseListener() {
        final boolean isRefreshFromTop = ("0".equals(mPage));
        return new Response.Listener<FeedRequestData>() {
            @Override
            public void onResponse(final FeedRequestData response) {
                TaskUtils

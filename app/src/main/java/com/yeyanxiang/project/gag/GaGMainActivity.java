...
public class GaGMainActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gagmainlayout);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.gagmain, menu);
		mMenu = menu;
		return true;
	}

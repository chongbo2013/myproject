package com.yeyanxiang.project.badgeview;
...
/**
 * 
 * Create on 2013-5-7 上午10:10:53 </br> Copyright: Copyright(c) 2013 by 叶雁翔</br>
 * 
 * 简介: 有标记的控件
 * 
 * @Version 1.0
 ...
 * 
 */
public class BadgeViewActivity extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.badgemain);

		final TabHost tabHost = getTabHost();

		tabHost.addTab(tabHost.newTabSpec("demos").setIndicator("Badge Demos")
				.setContent(R.id.tab1));

		tabHost.addTab(tabHost.newTabSpec("adapter")
				.setIndicator("List Adapter").setContent(R.id.tab2));

		tabHost.addTab(tabHost.newTabSpec("tests").setIndicator("Layout Tests")
		...
		badge6.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(BadgeViewActivity.this, "clicked badge",

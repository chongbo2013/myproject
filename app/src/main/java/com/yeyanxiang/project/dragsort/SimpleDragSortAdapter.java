...
import com.yeyanxiang.util.EnglishNumberToWords;
...
public class SimpleDragSortAdapter extends DragSortAdapter<SimpleDragSortAdapter.MainViewHolder> {

    public static final String TAG = SimpleDragSortAdapter.class.getSimpleName();

    private final List<Integer> data;

    public SimpleDragSortAdapter(RecyclerView recyclerView, List<Integer> data) {
        super(recyclerView);
        this.data = data;
    }
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.drag_sort_item, parent, false);

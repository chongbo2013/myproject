...
import com.yeyanxiang.view.RadialMenuWidget;
import com.yeyanxiang.view.RadialMenuWidget.RadialMenuEntry;
...
public class RadialMenuActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Generating Pie view
		// ------------------------------------------------------------------------------------------
		setContentView(R.layout.radiamenulayout);
		 ...
		 * LinearLayout.LayoutParams.FILL_PARENT,
		 * LinearLayout.LayoutParams.FILL_PARENT); final TextView tv = new
		 * TextView(this); tv.setText("Hello"); tv.setTextColor(Color.WHITE);
		 * ll.addView(tv); addContentView(ll, p);
		 */
		...
		testButton.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				/*
				 * try { Class<drawable> res = R.drawable.class; Field field =
				 * res.getField("icon"); int drawableId = field.getInt(null); }
				 * catch (Exception e) { Log.e("MyTag",
				 * "Failure to get drawable id.", e); }
				 */
	...
	public static class CircleOptions implements RadialMenuEntry {
		...
		private List<RadialMenuEntry> children = new ArrayList<RadialMenuEntry>(
				Arrays.asList(new RedCircle(), new YellowCircle(),
						new GreenCircle(), new BlueCircle()));

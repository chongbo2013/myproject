 ...
 * @update 2014年3月14日
 * 
 * @简介 This activity is an example of a responsive Android UI. On phones, the
 *     SlidingMenu will be enabled only in portrait mode. In landscape mode, it
 *     will present itself as a dual pane layout. On tablets, it will will do
 *     the same general thing. In portrait mode, it will enable the SlidingMenu,
 *     and in landscape mode, it will be a dual pane layout.
 */

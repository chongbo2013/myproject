...
public class PropertiesActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		behindWidth.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			@Override
			public void onStopTrackingTouch(SeekBar seekBar) {
				float percent = (float) seekBar.getProgress()
						/ seekBar.getMax();
				...
				.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
					public void onCheckedChanged(CompoundButton buttonView,
						...
						if (isChecked)
							getSlidingMenu()
									.setShadowDrawable(
											getSlidingMenu().getMode() == SlidingMenu.LEFT ? R.drawable.shadow
													: R.drawable.shadowright);
						else
		...
		shadowWidth.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onStopTrackingTouch(SeekBar seekBar) {
				...
				int width = (int) (percent * (float) getSlidingMenu()
						.getWidth());

...
class PacketWriter {
     ...
     * to the server.
     */
    void startKeepAliveProcess(ReConnectListener listener) {
        ...
        if (keepAliveInterval > 0) {
            KeepAliveTask task = new KeepAliveTask(keepAliveInterval, listener);
    ...
    private class KeepAliveTask implements Runnable {
        ...
        public KeepAliveTask(int delay, ReConnectListener listener) {
            this.delay = delay;

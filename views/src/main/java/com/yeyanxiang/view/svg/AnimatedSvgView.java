...
package com.yeyanxiang.view.svg;
...
public class AnimatedSvgView extends View {
    ...
    private int mTraceResidueColor = Color.WHITE;// 边缘线的颜色
    private int mTraceColor = Color.GREEN;// 滑动线的颜色
    private int mFillColor = Color.BLUE;//填充色
    private String[] mGlyphStrings;// 要绘制的路径数组
     ...
     * @param color
     */
    public void setTraceResidueColors(int color) {
     ...
     * @param color
     */
    public void setTraceColors(int color) {
        mTraceColor = color;
    }
     ...
     * @param color
     */
    public void setFillPaints(int color) {
        mFillColor = color;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mGlyphData.length; i++) {
            ...
            mGlyphData[i].paint.setStrokeWidth(5);

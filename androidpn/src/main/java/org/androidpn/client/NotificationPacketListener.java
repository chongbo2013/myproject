...
/**
 * 
 * Create on 2013-4-28 上午10:35:04 </br> Copyright: Copyright(c) 2013 by 叶雁翔</br>
 * 
 * 简介: This class notifies the receiver of incoming notifcation packets
 * asynchronously.
 * 
 * @Version 1.0
	...
	public void processPacket(Packet packet) {
		...
		if (packet instanceof NotificationIQ) {
			...
			if (notification.getChildElementXML().contains(
				...
				Intent intent = new Intent(xmppManager.getShowNotifyAction());

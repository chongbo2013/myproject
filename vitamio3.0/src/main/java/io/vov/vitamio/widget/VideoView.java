...
public class VideoView extends SurfaceView implements
	...
	public void setOnSeekStartListener(OnSeekStartListener l) {
		mOnSeekStartListener = l;
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		if (touchable && isInPlaybackState() && mMediaController != null)
	...
	public void start() {
		...
		if (mOnStartListener != null) {
			mOnStartListener.onStart(mMediaPlayer);
		}
	}
	...
	public void seekTo(long msec) {
		if (mOnSeekStartListener != null) {
			mOnSeekStartListener.onSeekStart(mMediaPlayer);
		}
		if (isInPlaybackState()) {
	...
	public void toggleLayout() {
		if (mVideoLayout == VIDEO_LAYOUT_STRETCH) {
			setVideoLayout(VIDEO_LAYOUT_SCALE, mVideoAspectRatio);
		} else {
			setVideoLayout(VIDEO_LAYOUT_STRETCH, mVideoAspectRatio);
		}
	}
